 ...
 * @author Evgeniya
 */
public class TEST_getJsonAll_users {
    ...
    public static void main(String[] args) {
        ...
        WebResource service = client.resource(UriBuilder.fromUri("http://localhost:8080/Inventory_RESTServer/webresources/users/all").build());
